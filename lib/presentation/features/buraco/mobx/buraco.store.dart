...
abstract class BuracoBase with Store {
  ...
  void setFullPlayersTeam() {
    if (players2Buraco) {
      fullPlayersTeam1 = nameJogador1Buraco;
      fullPlayersTeam2 = nameJogador6Buraco;
      return;
    }
    if (players4Buraco) {
      fullPlayersTeam1 = '$nameJogador1Buraco | $nameJogador2Buraco';
      fullPlayersTeam2 = '$nameJogador6Buraco | $nameJogador7Buraco';
      return;
    }
    if (players6Buraco) {
      fullPlayersTeam1 =
          '$nameJogador1Buraco | $nameJogador2Buraco | $nameJogador3Buraco';
      fullPlayersTeam2 =
          '$nameJogador6Buraco | $nameJogador7Buraco | $nameJogador8Buraco';
      return;
    }
    if (players8Buraco) {
      fullPlayersTeam1 =
          '$nameJogador1Buraco | $nameJogador2Buraco | $nameJogador3Buraco | $nameJogador4Buraco';
      fullPlayersTeam2 =
          '$nameJogador6Buraco | $nameJogador7Buraco | $nameJogador8Buraco | $nameJogador9Buraco';
      return;
    }
    if (players10Buraco) {
      fullPlayersTeam1 =
          '$nameJogador1Buraco | $nameJogador2Buraco | $nameJogador3Buraco | $nameJogador4Buraco | $nameJogador5Buraco';
      fullPlayersTeam2 =
          '$nameJogador6Buraco | $nameJogador7Buraco | $nameJogador8Buraco | $nameJogador9Buraco | $nameJogador10Buraco';
      return;
    }
  }
  ...
  @action
  void calcularRodada() {
    int canastraLimpa1 = int.tryParse(canastraLimpaTime1)! * 200;
    int canastraSuja1 = int.tryParse(canastraSujaTime1)! * 100;
    int cartas1 = int.tryParse(pontuacaoCartasTime1)!;
    int negativo1 = int.tryParse(pontuacaoNegativaTime1)!;
    ...
    // pontuação time 2 //
    //************************************************** */
    int canastraLimpa2 = int.tryParse(canastraLimpaTime2)! * 200;
    int canastraSuja2 = int.tryParse(canastraSujaTime2)! * 100;
    int cartas2 = int.tryParse(pontuacaoCartasTime2)!;
    int negativo2 = int.tryParse(pontuacaoNegativaTime2)!;
